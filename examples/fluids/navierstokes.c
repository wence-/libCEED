...
//TESTARGS(name="dc_implicit_stab_supg") -ceed {ceed_resource} -test -degree 2 -dm_plex_box_faces 1,1,2 -units_kilogram 1e-9 -lx 125 -ly 125 -lz 250 -center 62.5,62.5,187.5 -rc 100. -thetaC -35. -ts_adapt_safety 0.8 -snes_atol 1e-3 -ksp_atol 1e-4 -ksp_rtol 1e-3 -ts_type alpha -ts_dt 2e-3 -ksp_type bcgs -pc_type lu -implicit -ts_type alpha -stab supg -compare_final_state_atol 5E-4 -compare_final_state_filename examples/fluids/tests-output/fluids-navierstokes-dc-implicit-stab-supg.bin
